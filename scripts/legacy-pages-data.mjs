...
export default [
  ...
  // ---------------------------------------------------------------------
  // 5. extended-stays — INTENTIONALLY NOT SEEDED.
  //
  // Removed 2026-09-16. The route is now code-owned by
  // src/pages/extended-stays.astro, which takes precedence over the dynamic
  // [slug].astro catch-all. The seed entry that used to live here carried the
  // old availability copy ("Step 1: Call the Office", "November 1 through
  // April 30", a form POSTing to /extended-stays) and would have quietly
  // reintroduced a stale, unreachable duplicate of the page if this script
  // were ever re-run. Availability numbers and dates live in
  // src/lib/availability.ts — edit there, not here.
  // ---------------------------------------------------------------------
